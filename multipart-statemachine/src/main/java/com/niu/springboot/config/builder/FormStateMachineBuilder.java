 ...
 *
 * @author [nza]
 * @version 1.0 [2021/06/11 11:26]
 * @createTime [2021/06/11 11:26]
 */
@Component
@Slf4j
public class FormStateMachineBuilder {

    public static final String MACHINE_ID = "formMachine";

    public StateMachine<FormStates, FormEvents> build(BeanFactory beanFactory) throws Exception {

        log.info("构建表单状态机");

        final StateMachineBuilder.Builder<FormStates, FormEvents> builder = StateMachineBuilder.builder();
